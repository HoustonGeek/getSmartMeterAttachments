...
def search_emails(query_string, label_ids: List=None):
    try:
...
if __name__ == '__main__':
    CLIENT_FILE = 'client_secret_48495210243-ukjgfvbmtcbeube7gfdhdf4op5tfg7b5.apps.googleusercontent.com.json'
    API_NAME = 'gmail'
    API_VERSION = 'v1'
        ...
        if 'parts' in messageDetailPayload:
            for msgPayload in messageDetailPayload['parts']:
                ...
                if 'attachmentId' in body:
                    ...
                    if str(file_name).startswith('IntervalMeterUsage'):
